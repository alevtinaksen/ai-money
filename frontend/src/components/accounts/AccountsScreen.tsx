    ...
    <div className="min-h-screen bg-[#F6F7FB] flex flex-col justify-between pb-10 select-none animate-fade-in relative">
      ...
      <div className="flex-1 px-5 max-w-lg mx-auto w-full">
        ...
        <div className="text-center my-6">
          ...
          <p className="text-[14px] text-[#9CA3AF] font-medium mt-1">Общий баланс</p>
          <p className="text-[12px] text-[#9CA3AF] mt-1 flex items-center justify-center space-x-1">
            <span>ⓘ</span>
              ...
              <div key={groupName} className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-[12px] font-semibold text-[#6B7280] bg-[#E5E7EB] px-2 py-0.5 rounded-full">
                      {groupAccs.length}
                    </span>
                  </div>

                  <span className="text-[14px] font-semibold text-[#6B7280]">
                    {groupSum.toLocaleString('ru-RU', {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}{' '}
                    ₽
                  ...
                  <div className="flex flex-col items-start gap-2.5">
                    {groupAccs.map((acc) => (
                      <button
                        ...
                        className="inline-flex items-center space-x-2.5 bg-white px-4 py-2.5 rounded-full shadow-sm border border-gray-100/80 active:scale-[0.98] transition-all"
                      >
