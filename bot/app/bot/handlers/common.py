...
SUBCATEGORY_KEYWORDS = [
    ...
    (("дом", "для дома", "товары для дома", "посуда", "текстиль", "хофф", "hoff", "икеа", "ikea", "леруа", "leroy", "уют", "мебель"), ("Покупки", "🏡", "Дом")),
    (("аптека", "лекарств", "ригла", "горздрав", "вита", "еаптека"), ("Здоровье", "💊", "Лекарства")),
    (("врач", "клиник", "стоматолог", "зуб", "доктор", "анализ"), ("Здоровье", "🩺", "Врачи")),
    (("маникюр", "педикюр", "стрижк", "салон", "парикмахер", "косметик", "ногти", "ресниц", "бров", "массаж", "внешний вид", "уход", "барбер"), ("Личное", "💄", "Внешний вид")),
    (("спорт", "фитнес", "зал", "тренировк", "тренер", "бассейн", "йога"), ("Личное", "🏃", "Спорт")),
    (("привычк", "вейп", "сигарет"), ("Личное", "☕", "Привычки")),
    (("корм", "вискас", "зоомагазин", "четыре лапы"), ("Кот", "🐟", "Корм для кота")),
    (("ветклиник", "ветеринар"), ("Кот", "🐾", "Здоровье кота")),
]
